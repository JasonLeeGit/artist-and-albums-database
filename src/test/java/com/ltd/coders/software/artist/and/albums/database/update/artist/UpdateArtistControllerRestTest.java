...
public class UpdateArtistControllerRestTest extends ControllerJsonMapper {
	...
	public void updateArtistWhenAllDetailsPresentTest() throws Exception {
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.put("/v1/artist/service/artist/album-name?artist-id=1&old-album-name=" + ARTIST_NAME_ONE
						+ "&new-album-name=" + UPDATED_ARTIST_NAME))
	...
	public void updateArtistMissingArtistNameTest() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(
				"/v1/artist/service/artist/album-name?artist-id=1&old-album-name=&new-album-name=" + UPDATED_ARTIST_NAME))
	...
	public void updateArtistMissingNewAlbumNameTest() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/v1/artist/service/artist/album-name?artist-id=1&old-album-name=" + ARTIST_NAME_ONE + "&new-album-name="))
				.andExpect(status().is4xxClientError()).andReturn();
